Name - Kaustubh Rajpathak
UTA ID - 1001770219

Programming Language used: Java (javac -version 1.8.0_161)
...
Files : - Submitted a ZIPPED directory called assignment3_kkr0219.zip. Task 2 code is contained in wumpus_world folder.
...
cd /Users/kaustubhrajpathak/Desktop/assignment3_kkr0219/Task2/wumpus_world (in my case, folder name is wumpus_world)
...
addl_kb-5.txt contains the knowledge base sent through email.

Eg: java CheckTrueFalse wumpus_rules.txt addl_kb-5.txt c.txt (for P_4_4)
        
java CheckTrueFalse wumpus_rules.txt addl_kb-5.txt c1.txt (for P_3_3)
        
java CheckTrueFalse wumpus_rules.txt addl_kb-5.txt c2.txt (for M_3_4)
...
time java CheckTrueFalse wumpus_rules.txt addl_kb-5.txt c.txt (for P_4_4)
   
time java CheckTrueFalse wumpus_rules.txt addl_kb-5.txt c1.txt (for P_3_3)
   
time java CheckTrueFalse wumpus_rules.txt addl_kb-5.txt c2.txt (for M_3_4)
